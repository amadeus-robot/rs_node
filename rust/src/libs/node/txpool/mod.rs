...
// static TX_POOL: LazyLock<DashMap<(u64, Vec<u8>), TXU>> = LazyLock::new(|| DashMap::new());
static GIFTED_SOL_CACHE: LazyLock<DashMap<Vec<u8>, u64>> = LazyLock::new(|| DashMap::new());
...
// impl TXPool {
//     pub fn init() {
//         LazyLock::force(&TX_POOL);
//         LazyLock::force(&GIFTED_SOL_CACHE);
//     }
