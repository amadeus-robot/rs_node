...
impl Base {
    ...
    //                 if amount <= 0 {
    //                     return TxResult::Err("invalid_attached_amount");
    //                 }
    //                 if amount
    //                     > BIC::Coin::balance(
    ...
    //                     )
    //                 {
    //                     return TxResult::Err("attached_amount_insufficient_funds");
    //                 }
    ...
    //             let mut result =
    //                 BIC::Base::WASM::call(env, &bytecode, &action.function, &action.args);
